            ...
            <x-slot name="heading">
                ...
                <div class="float-left mt-2">
                    ...
                    <x-filament::modal id="delete-confirmation-modal">
                        ...
                        <x-filament::button color="success" x-on:click="$dispatch('close-modal', { id: 'delete-confirmation-modal' })">
                            Tidak, batalkan
                        </x-filament::button>
                    </x-filament::modal>
                ...
                <tr>
                    <td colspan="3" class="border px-4 py-2">
                        ...
                        @elseif ($this->pengumpulanTugas->filePengumpulanTugas->count() < 2)
                            ...
                            @endphp
                            <a href="{{ Storage::url($filePengumpulan->file) }}" class="text-blue-500 hover:underline"
                                target="_blank">
